...
async function captureSurface(
  ...
  await page.screenshot({
    path: `docs/design-review/after/${name}-${viewport.width}x${viewport.height}.png`,
    fullPage: true,
  });
}

test.describe("Design review — after screenshots", () => {
  ...
  test("pos — empty", async ({ page }) => {
    ...
    await page.screenshot({
      path: "docs/design-review/after/pos-empty-1440x900.png",
      fullPage: true,
    });
  });
  ...
  test("pos — populated cart with open modifier sheet", async ({ page }) => {
    ...
    await page.screenshot({
      path: "docs/design-review/after/pos-modifier-sheet-open-1440x900.png",
      fullPage: true,
    });
  });
  ...
  test("pos — mobile", async ({ page }) => {
    ...
    await page.screenshot({
      path: "docs/design-review/after/pos-390x844.png",
      fullPage: true,
    });
  });
  ...
  test("drive-thru", async ({ page }) => {
    ...
    await page.screenshot({
      path: "docs/design-review/after/drive-thru-1440x900.png",
      fullPage: true,
    });
    await addItemToCart(page, "ميلك تي كلاسيك", [], "إضافة");
    await page.screenshot({
      path: "docs/design-review/after/drive-thru-cart-open-1440x900.png",
      fullPage: true,
    });
  });
  ...
  test("kitchen — with orders", async ({ page }) => {
    ...
    await page.waitForTimeout(1500);
    await page.screenshot({
      path: "docs/design-review/after/kitchen-1440x900.png",
      fullPage: true,
    });
  });
  ...
  test("order — cart open", async ({ page }) => {
    ...
    await page.waitForTimeout(300);
    await page.screenshot({
      path: "docs/design-review/after/order-cart-open-390x844.png",
      fullPage: true,
    });
  });
  ...
  test("order status", async ({ page }) => {
    ...
    await page.screenshot({
      path: `docs/design-review/after/order-status-${orderId}-390x844.png`,
      fullPage: true,
    });
  });
  ...
  test("admin — dashboard", async ({ page }) => {
    ...
    await page.screenshot({
      path: "docs/design-review/after/admin-dashboard-1440x900.png",
      fullPage: true,
    });
  });
  ...
  test("admin — inventory", async ({ page }) => {
    ...
    await page.screenshot({
      path: "docs/design-review/after/admin-inventory-1440x900.png",
      fullPage: true,
    });
  });
  ...
  test("admin — reports", async ({ page }) => {
    ...
    await page.screenshot({
      path: "docs/design-review/after/admin-reports-1440x900.png",
      fullPage: true,
    });
  });
  ...
  test("admin — menu", async ({ page }) => {
    ...
    await page.screenshot({
      path: "docs/design-review/after/admin-menu-1440x900.png",
      fullPage: true,
    });
  });
  ...
  test("admin — staff", async ({ page }) => {
    ...
    await page.screenshot({
      path: "docs/design-review/after/admin-staff-1440x900.png",
      fullPage: true,
    });
  });
  ...
  test("admin — settings", async ({ page }) => {
    ...
    await page.screenshot({
      path: "docs/design-review/after/admin-settings-1440x900.png",
      fullPage: true,
    });
  });
});
